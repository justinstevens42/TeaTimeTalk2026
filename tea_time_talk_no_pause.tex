...
\begin{frame}{Methodology: one Claude call per problem}
  \begin{itemize}
...
\begin{frame}{Comparing Routine vs. Complex Problem Types}
  Group the hints by classification of \emph{Quarfoot type}, split into \textbf{routine} $=$ first notes/accidentals/chords/etudes (2{,}880 problems, 19{,}046 transitions)
  vs.\ \textbf{complex} $=$ improvisations/interpretations/first pieces/showpieces/masterpieces (1{,}163 problems, 8{,}524 transitions):  
...
\begin{frame}{Breakdown of Routine vs. Complex Problems}
  \begin{table} 
    ...
    \begin{tabular}{lrccc}
      \toprule
      type & $n$ & Principle Stating \% & $b\to b$ & Extension \% \\
      \midrule
...
Claude's Anthropic Opus 4.8 \& Fable models were used to assist with writing code and analysis and to help create a first draft of these slides, which were then refined by the author to deliver this presentation. 
