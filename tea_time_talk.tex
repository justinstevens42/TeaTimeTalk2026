...
\begin{frame}{Not a threshold but a gradient --- and where it ends}
  \begin{columns}[T]
    ...
    \begin{itemize}
      \item The split is not an artifact of where the line is drawn: moving FN $\to$ SP,
            principle-stating falls $31\% \to 13\%$, $b\to b$ climbs $0.56 \to 0.78$,
            extensions fade $10\% \to 2\%$
      \item Reading: routine problems' hints \emph{teach} --- state the rule, compute,
            generalize at the end; complex problems' hints \emph{build} --- chain the
            construction step by step
      \item \textbf{Hints stop teaching and start building.}
